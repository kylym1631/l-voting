...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
       <header class="flex items-center justify-between lg:px-8 py-4">
    ...
    <main class="container mx-auto max-w-custom flex" >
        <div class="w-70 mr-5" >
            Add idea form goes here. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores beatae cumque doloremque dolores doloribus, eum facere illo inventore ipsam magni maiores necessitatibus nemo odit quia quisquam sint tempora ut veniam voluptates voluptatum? A assumenda culpa delectus ea labore quibusdam velit!
        </div>
        <div class="w-175">
